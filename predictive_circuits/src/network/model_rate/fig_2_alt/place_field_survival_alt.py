...
class PlaceFieldFormation(BaseModel):
    ...
    def process_misc_after(self, misc_after):
        ...
        if misc_after.get('decay', False):
            ...
            self.neuron_params['decay_fac'][mask_2] *= np.exp(-0.00)
    ...
    def PP_generation(self, i, self_gen=False, PPs=None):
        ...
        dSpike_prob[mask] = 0.1 + self.neuron_params['tau_acc'][mask]
...
if __name__ == "__main__":
    ...
    for i in range(nums):
        ...
        if i  == 0:
            ...
            #neuron.neuron_params['tau_acc'] = tau_acc
            state = neuron.run_passive(state, 1.2)
