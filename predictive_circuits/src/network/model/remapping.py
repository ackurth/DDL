...
if __name__ == "__main__":
    ...
    with open('remapping/traces.pkl', 'wb') as f:
    ...
    np.save('remapping/results.npy', np.array(results))
    np.save('remapping/sorting.npy', np.array(sorting))
    ...
    plt.savefig("remapping/repeat.png")
